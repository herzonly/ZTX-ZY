module.exports = (conn) => {
  conn.sendMessage = async (jid, content, options = {}) => {
    try {
      ...
      require("./lib/print")({ content: { text: messageText }, chat: jid }, conn, true)
      return result
      }
      ...
      require("./lib/print")({ content: { photo, caption: content.caption }, chat: jid }, conn, true)
      return result
      }
      ...
      require("./lib/print")({ content: { video, caption: content.caption }, chat: jid }, conn, true)
      return result
      }
      ...
      require("./lib/print")({ content: { audio, caption: content.caption }, chat: jid }, conn, true)
      return result
      }
      ...
      require("./lib/print")({ content: { document, caption: content.caption }, chat: jid }, conn, true)
      return result
      }
      ...
      require("./lib/print")({ content: { sticker }, chat: jid }, conn, true)
      return result
      }
  ...
  conn.sendFile = async (jid, path, filename = "", caption = "", quoted, options = {}) => {
    try {
      ...
      if (typeof path === "string" && path.startsWith("http")) {
        ...
        require("./lib/print")({ content: { document: path, caption }, chat: jid }, conn, true)
        return result
      } else {
